game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"阳光包",content:function (config,pack){
    ...
    //精品武将
    lib.rank.rarity.rare.addArray(["lyz_huangyueying","lyz_zhangxingcai","lyz_xinxianying","lyz_jiaxu"]);
    //史诗武将
	lib.rank.rarity.epic.addArray(["lyz_zhouyu","lyz_lingju","lyz_caiwenji","lyz_zhenji","lyz_daqiao","lyz_xiaoqiao","lyz_sunshangxiang","lyz_simayi","lyz_guojia","lyz_huatuo","lyz_caojie","lyz_caocao","lyz_liubei","lyz_sunjian","lyz_zhangjiao","lyz_zhangchunhua","lyz_luxun","lyz_diaochan","lyz_guanyinping","lyz_zhangliao","lyz_bulianshi"]);
	//传说武将
	lib.rank.rarity.legend.addArray(["lyz_zhaoyun","lyz_shen_diaochan","lyz_shen_zhangliao","lyz_shen_gaodayihao","lyz_zhugeliang","lyz_mayunlu","lyz_shen_lvbu","lyz_machao","lyz_shen_simayi","lyz_shen_zhouyu","lyz_yangguangweiliang","lyz_zhangfei","lyz_yjlgt","lyz_guanyu","lyz_xunyu","lyz_shijian","lyz_lvlingqi","lyz_zuoci","lyz_sunce","lyz_ziyu","lyz_xusheng","lyz_xuedaoshaozhu","lyz_shen_zhenji","lyz_shen_zhugeliang"]);
    ...
    if(yangguangbao.enable){
         game.import("character",function(){
             var yangguangbao={
                 ...
                 characterSort:{
            yangguangbao:{
                "lyz_shen":["lyz_shen_zhugeliang","lyz_shen_zhenji","lyz_shen_diaochan","lyz_shen_zhangliao","lyz_shen_gaodayihao","lyz_shen_lvbu","lyz_shen_simayi","lyz_shen_zhouyu","lyz_shen_zhenji"],
                "lyz_wei":["lyz_xinxianying","lyz_zhangliao","lyz_xunyu","lyz_caiwenji","lyz_zhenji","lyz_simayi","lyz_guojia","lyz_caocao","lyz_zhangchunhua"],
                "lyz_shu":["lyz_guanyinping","lyz_guanyu","lyz_zhangfei","lyz_zhaoyun","lyz_zhugeliang","lyz_mayunlu","lyz_huangyueying","lyz_liubei","lyz_zhangxingcai"],
                ...
                "lyz_caidan":["lyz_yangguangweiliang","lyz_yjlgt","lyz_shijian","lyz_ziyu","lyz_xuedaoshaozhu"],
            },
        },
        character:{
            "lyz_zhaoyun":["male","shu",4,["lyzlongying","lyzhunyou","lyzcuizhen","lyzchengyu"],["die_audio"]],
            ...
            "lyz_zhangliao":["male","wei",4,["lyzweizhen","lyzshepo","lyzliaolai"],["die_audio"]],
        ...
        characterIntro:{
            "lyz_zhaoyun":"<br>武将定位：爽将。<br> <br>武将简介——血染征袍透甲红，当阳谁敢与争锋！古来冲阵扶危主，只有常山赵子龙。",
            ...
            "lyz_shen_lvbu":"<br>武将定位：输出·爆发·防御。<br> <br>武将简介——☼神吕布采用了“使命技”的新机制，取材于吕布雄踞虎牢，勇斗三英的故事。技能1〖搦战〗与技能2〖镇关〗均为☼神吕布的使命——镇守虎牢关服务。依据距离和武将能力合理地交出“英”标记，能帮助☼神吕布更快地达成使命。技能3〖虓虎〗为过牌+防御技能，合理卖血能够最大化其收益。达成使命后，〖极武〗和〖溃魄〗将使得☼神吕布拥有恐怖的杀伤力和控制力。若使命失败，〖利驭〗会为☼神吕布提供一些非基本牌以配合〖虓虎〗的发动，但〖无谋〗则会对☼神吕布进行较大的限制。",
            ...
            "lyz_sunshangxiang":"<br>武将定位：输出·过牌。<br> <br>武将简介——☼孙尚香的设计灵感来源于演义中她“好武事，娴弓马”的性格特点，并未涉及与刘备的政治婚姻。技能1〖备武〗为基础技能，获取标记的方式共有三种，最优的是使用装备牌。技能2〖娇弓〗为核心技能，具备使用【杀】、无视距离、过牌和增伤的效果。需注意的是，当☼孙尚香使用一张【杀】指定多个目标后，需依次选择是否获得目标的一张牌，每获得一张牌需消耗1个标记。若自身只有1枚“武”，不可通过使用装备牌触发〖枭姬〗。在多名敌人横置的情况下，☼孙尚香可通过不断移去标记使属性伤害递增。总体上，☼孙尚香能作为输出核心，为团队创造极大的优势。",
            ...
            "lyz_zhangchunhua":"<br>武将定位：限制·控制。<br> <br>武将简介——原版张春华在目前对局中已经难有出彩表现，故对她进行了重塑。阳光包的☼张春华拥有完全不同的技能机制，但保留甚至加强了信仰能力以及对卖血将的克制能力。技能1〖残情〗为限制+过牌技能，用法较多，可选择对方的手牌进行摸奖或小制衡，也可在自身被【杀】指定时卸除敌人的关键武器。技能2〖惋哀〗为强力控制技能，在自身状态较差时能力更突出。〖惋哀〗对以神郭嘉为代表的回合内爆牌武将和以曹金玉为代表的高收益卖血武将具有极强的克制效果。",
            ...
            "lyz_yangguangweiliang":"<br>武将定位：彩蛋。<br> <br>武将简介——<br>阳光包的彩蛋，享受被女武将们包围的感觉吧！",
            ...
            "lyz_yjlgt":"<br>武将定位：彩蛋。<br> <br>武将简介——<br>遗计两个桃，《无名杀全教程》作者兼主编。在位时治理群聊、解决萌新问题都颇有建树，也被其他群友亲切地称为“桃子姐姐”。“读 教 程”是他的名言，也是〖治典〗的由来。〖检记〗的原型是他写的《死亡笔记》和常说的“突袭检查”。不过遗计两个桃现已经隐退，不多过问江湖。",
            ...
            "lyz_zhangliao":"<br>武将定位：限制·控制。<br> <br>武将简介——阳光包的☼张辽取材于合肥战场大破吴军，意气风发，使小儿闻名止啼的张辽形象。技能1〖威震〗为收益技能，通过对敌方造成伤害震慑敌军，当自身输出足够后，〖威震〗可达到甚至超越〖突袭〗的效果。技能2〖慑魄〗为控制技能，通过限制敌方出牌的类别来达成强力的控制效果，在使用时需注意其发动的条件与次数。技能3〖辽来〗为控制+输出技能，若要快速达成条件，需注意技能顺序——先进行输出触发〖威震〗，然后发动〖慑魄〗。在自身体力值较低时，可对一名敌人连续多次发动〖慑魄〗来确保〖威震〗和〖辽来〗的发动。",
            ...
            "lyz_shijian":"<br>武将定位：彩蛋。<br> <br>武将简介——<br>人美声甜而且代码力MAX的超（无）可（名）爱（杀）的（圈）小（内）姐（大）姐（佬），代表作是《合纵抗秦》和《在线更新》，其中《在线更新》造福了含作者在内的广大无名杀玩家，真的不试试吗？",
            "lyz_lvlingqi":"<br>武将定位：输出·爆发。<br> <br>武将简介——官方的吕玲绮拥有贴近父亲吕布的人设“阳光包则尝试呈现一个下邳之战时“四面楚歌，孤军奋战”的战神之女形象。技能1〖战陌〗为收益技能，在自身状态不佳时具有强大的威慑力，但也使得玩家在操作时☼吕玲绮需谨慎使用装备牌。技能2〖犹凛〗为核心技能，选择合适的效果能够配合〖战陌〗发挥最大的能力。牌局后期，☼吕玲绮能通过不断废除装备栏来取得不俗的回复和续战能力。",
            ...
            "lyz_jiaxu":"<br>武将定位：辅助·防御·输出。<br> <br>武将简介——贾诩在作者的印象中是个计出必成、明哲保身的“毒士”形象，因此在阳光包中进行了相应呈现。技能1〖谏杀〗为输出+辅助技能，主效果为提升一张伤害牌的收益，“无次数限制”指的是不计入次数且无次数限制。技能2〖引澜〗同为输出+辅助技能，配合〖谏杀〗与某些菜刀武将更有不错的发挥，额外指定的目标没有距离限制。技能3〖泯微〗为防御技能，能为手牌稀缺的☼贾诩提供一定的过牌，但也会出现不能被喂桃和享受增益锦囊的负面情况。整体上，合理规划自身的过牌技能和有限的手牌，最大化自身在场上的效果，是操控☼贾诩的关键所在。",
            ...
            "lyz_ziyu":"<br>武将定位：彩蛋。<br> <br>武将简介——<br>专注美化30年的无名杀隐藏大佬，还兼职开展编写教程、教导萌新、宣传无名杀、代裁露头等众多业务。一位自信音游人！",
            ...
            "lyz_xuedaoshaozhu":"<br>武将定位：彩蛋。<br> <br>武将简介——<br>玄武江湖创始人之一，无名杀玄武版负责人之一，千幻聆音美化总监，主要负责工作扩展内文案编辑，台词配音设计，扩展外交运营；目前与玄武建交合作的扩展有血色衣冠，阳光包，秦时明月，时空枢纽，云将等。（除了XP有点奇怪）",
            ...
            "lyz_shen_zhugeliang":"<br>武将定位：控场·辅助·输出。<br> <br>武将简介——☼神诸葛亮的设计思路来自于诸葛亮创立的军阵—八卦阵，及诸葛亮本人的道士形象。技能1〖斗转〗与技能2〖星锁〗为互相配合的核心技能。阵列角色将拥有高额的输出能力和一定的防御能力，操作☼神诸葛亮的玩家需合理规划“阵”的布置，在适当时机，也要给予敌人“阵”，以便对夹击的另一敌人造成高额伤害。若场上只有两名角色存活，则均视为对方的上下家，阵列角色的加伤会直接触发。技能3〖天汲〗为特色技能，通过消耗暂不需要的体力上限，来获取存过牌能力和珍贵的排兵布阵的机会，最大程度减少☼神诸葛亮给敌人“阵”的负面影响。最后一句的描述对包括刘禅〖放权〗在内的所有你执行的额外回合均生效。",
       ...
       skill:{
            ...
            lyzxingsuo3:{
                ...
                filter:function(event,player){
                     if(player.hasSkill("lyzzhen")) return false;
                     return player.previous.hasSkill("lyzzhen")&&player.next.hasSkill("lyzzhen");
                },
                content:function(){
                    player.logSkill("lyzxingsuo");
                    trigger.num++;
                ...
                ai:{
                    effect:{
                        target:function(card,player,target,current){
                            if(get.tag(card,'damage')&&target.previous.hasSkill("lyzzhen")&&target.next.hasSkill("lyzzhen")) return [1,-2];
                        }
                    }
                }
            },
            ...
            lyzqiqing:{
                ...
                content:function(){
                    ...
                    event.finish();
                    "step 3"
                    player.chooseBool("摸一张牌，或点取消令自己此回合受到的伤害-1");
                    "step 4"
                    if(result.bool){
                         player.draw();
                         if(game.hasPlayer(function(current){
            ...
            lyzfengyi:{
				...
				prompt:function(event,player){
                    return "是否发动〖凤逸〗，令"+get.translation(event.card)+"对你无效？";
                },
                check:function(event,player){
				...
				subSkill:{
				       use:{
                          ...
                          priority:10,
                          prompt:function(event,player){
                               return "是否发动〖凤逸〗，令"+get.translation(event.card)+"不可被响应？";
                           },
				          filter:function(event,player){
				             var suit=get.suit(event.card);
                             if(!player.storage.lyzjingxing.contains(suit)) return false;
            ...
            return ui.create.dialog('龙影',[list,'vcard']);
        },
            ...
            lyzhunyou:{
                ...
                content:function (){
                  ...
                  if(get.type(event.card,'trick')!=get.type(trigger.getParent().card,'trick')){
                         event.disbool=true;
						player.chooseTarget('是否弃置一名角色区域里的一张牌？',function(card,player,target){
        ...
        if(result.bool){
            ...
            lyzchengyu:{
                ...
                content:function (){
                  ...
                  player.chooseButton(['骋宇：选择要使用的牌，或点取消摸两张牌',[list,'vcard']],function(button){
						return _status.event.player.getUseValue({name:button.link[2],nature:button.link[3]});
					},function(button){
						return _status.event.player.hasUseTarget({name:button.link[2],nature:button.link[3]});
					});
...
;                            player.addTempSkill("lyzjianji_remove");
            ...
            lyzzhenguan:{
                ...
                filter:function(event,player){
                   return event.card&&(event.card.name=="sha"||event.card.name=="juedou")&&
                      event.player&&event.player.isIn()&&event.player.hasSkill("ying_lyz_shen_lvbu");
                },
                content:function(){
                ...
                ai:{
                   ...
                   effect:{
                      player:function(card,player,target){
                         if((card.name=="sha"||card.name=="juedou")&&target.hasSkill("ying_lyz_shen_lvbu")&&target.hp>1&&get.attitude(player,target)>=0) return [1,1,0,0];
                         if(get.tag(card,"damage")&&((_status.event.type=="respondShan"&&_status.event.getParent().name=="sha")||(_status.event.type=="respondSha"&&_status.event.getParent().name=="juedou"))&&target.hasSkill("ying_lyz_shen_lvbu")&&get.attitude(target,player)>=0) return [1,1,0,0];
                      }
                   }                
                },
                subSkill:{
               ...
               mod:{
			    ...
			    subSkill:{
			       damage:{
			           ...
			           content:function(){
			                "step 0"
			                player.chooseToDiscard("he","〖虓虎〗：是否弃置一张非基本牌令此伤害-1？",function(card,player){
			                     return get.type(card)!="basic";
			                }).set("ai",function(card){
			                     return 10-get.value(card);
			                });
          ...
          if(!player.storage.lyzxianshi) player.storage.lyzxianshi=[];
           ...
           lyznewkunfen:{
            ...
            lyzweizhen:{
                ...
                content:function(){
                    trigger.player.addMark("lyzweizhen",trigger.num*2);
                },
                subSkill:{
                    gain:{
                        trigger:{
                        ...
                        filter:function(event,player){
                            var num=game.countPlayer(function(current){
                                 return current.countMark("lyzweizhen")>0;
                            });
                            return num>0;
                        },
                        direct:true,
                        content:function(){
                            "step 0"
                            player.chooseTarget('请选择任意名有“震”的角色，依次获得这些角色区域里的一张牌',[1,Infinity],function(card,player,target){
                                  return target.countCards('hej')>0&&target.countMark("lyzweizhen")>0;
                            }).set('ai',function(target){
                                  return -get.attitude(_status.event.player,target)+0.5;
                            });
                            "step 1"
                            if(result.bool&&result.targets){
                                player.logSkill("lyzweizhen");
                                player.line(result.targets,'green');
                                event.targets=result.targets;
                                event.targets.sort(lib.sort.seat);
                            }
                            ...
                            var num=0;
                            event.num=0;
                            targets[num].removeMark("lyzweizhen",1);
                            if(player.isAlive()&&event.targets.length){
                                player.gainPlayerCard(event.targets.shift(),'hej',true);
                            }
                            "step 3"
            ...
            lyzshepo:{
                ...
                enable:"phaseUse",
                filter:function(event,player){
                    if(player.getStat().skill.lyzshepo>=Math.max(1,Math.ceil(player.getDamagedHp()/2))) return false;    
                    return true;            
                },                
                filterTarget:function(card,player,target){
                ...
                init:function (player,skill){
                    var players=game.filterPlayer();
                    for(var i=0;i<players.length;i++){
                        if(!players[i].storage.lyzshepo){
                              players[i].storage.lyzshepo=[];
                          }                      
                    }                
                },
                content:function(){
                    ...
                    event.videoId=lib.status.videoId++;
                    var cards=target.getCards('h');
                    event.dialog=ui.create.dialog('慑魄',cards);
                    ...
                    if(result.bool){
                        ...
                        if(target.getStorage("lyzshepo")&&target.storage.lyzshepo!=undefined&&target.storage.lyzshepo.length>0){
                            var list=target.getStorage("lyzshepo");
                            var card=list.randomGet();
                            target.storage.lyzshepo.remove(card);
                            game.cardsDiscard(card);
                            target.$throw(card);
                            game.log(target,'将',card,'置入弃牌堆');
                            target.syncStorage('lyzshepo');
                            if(target.storage.lyzshepo.length==0){
                                 target.unmarkSkill('lyzshepo');
                             }                        
                        }
                        target.storage.lyzshepo=target.storage.lyzshepo.concat(result.links[0]);
                        target.markSkill('lyzshepo');
                        target.syncStorage('lyzshepo');
                        target.lose(event.card,ui.special,'toStorage');
                        target.$give(event.card,target,false);;
                        target.addSkill("lyzshepo2");                    
                    }
                    else {
                        event.dialog.close();
                        event.finish();
            ...
            lyzshepo2:{
                ...
                mod:{
                    cardEnabled:function(card,player){
                        if(player.getStorage('lyzshepo').filter(function(magic){
                            return get.type(magic)==get.type(card);
                        }).length) return false;
                    },
                ...
                filter:function(event,player){
                    return player.getStorage("lyzshepo")&&event.num<0;
                },
                forced:true,
                content:function(){
                    var list=player.getStorage("lyzshepo");
                    var card=list.randomGet();
                    player.storage.lyzshepo.remove(card);
                    game.cardsDiscard(card);
                    player.$throw(card);
                    game.log(player,'将',card,'置入弃牌堆');
                    player.syncStorage('lyzshepo');
                    if(player.storage.lyzshepo.length==0){
                        player.unmarkSkill('lyzshepo');
                    }
                }
            },
            lyzliaolai:{
                ...
                filter:function(event,player){
                    return event.player!=player&&
                    event.player.storage.lyzshepo!=undefined&&
                    event.player.storage.lyzshepo.length>0&&
                    event.player.countMark("lyzweizhen")>0;
                },
                forced:true,
                content:function(){
                    "step 0"
                    trigger.player.chat("辽来！辽来！");
                    "step 1"
                    trigger.player.loseHp();
                    "step 2"
                    trigger.player.addTempSkill("lyzliaolai2");
                }
            },
            lyzliaolai2:{
                  mod:{
					cardEnabled:function(card){if(card. name!='tao') return false}
				},
				charlotte:true,            
            },
            lyztaoming:{
			 ...
			 lyzyoulin:{
			     ...
			     subSkill:{
			         jieshu:{
                        ...
                        var num=list.randomGet();
                        player.enableEquip(num);
                        
                        "step 3"
                        var list2=[];
                        for(var i=1;i<6;i++){
                            if(player.isDisabled(i)) list2.add(i);
                        }
            ...
            subSkill:{
				...
				save:{
				   ...
				   cardSavable:function(card,player,target){
						if((card.name=='tao'||card.name=='jiu')&&target.storage.lyzminwei_mod&&target.storage.lyzminwei_mod.contains('basic')) return false;
					}				   
				   }								
				},
				clear:{
			...
			audio:"ext:阳光包/audio:2",  
		 	...
		 	content: function() {
				...
				input.addEventListener('keyup', e => {
		 		...
		 		/* 输入提示,如果不需要请删除相关代码 */
		 		var datalist = div.appendChild(document.createElement('datalist'));
		 		/* 添加输入提示，默认提示是在场所有武将的名字 */
		 		var list = game.players.map(item => lib.translate[item.name]);
		 		for (var data of list) {
		 			var option = document.createElement('option');
		 			option.value = data;
		 			datalist.appendChild(option);
		 		}
		 		/* input设置list属性，和datalist的id属性一致则可以获得输入提示 */
		 		input.setAttribute('list', '技能名_datalist');
		 		datalist.setAttribute('id', '技能名_datalist');
		 		/* dialog添加div */
		 		dialog.add(div);
         ...
         translate:{
            ...
            lyzlongying:"龙影",
            "lyzlongying_info":"锁定技，你可将一张红色基本牌当火【杀】或【桃】使用或打出；你可将一张黑色基本牌当【闪】或【酒】使用或打出。",
            lyzhunyou:"魂佑",
            "lyzhunyou_info":"锁定技，当你于回合外使用或打出手牌后，你展示牌堆顶的一张牌并可将之交给一名角色，然后若这两张牌类别相同，你可令一名角色回复1点体力；否则你可弃置一名角色区域里的一张牌。",
            lyzcuizhen:"摧阵",
            "lyzcuizhen_info":"当你使用【杀】指定目标后，你可进行一次判定并令目标角色的技能失效直至回合结束，然后其选择一项：交给你一张与判定牌花色相同的牌；或不能使用或打出手牌直至回合结束。",
            "lyzcuizhen2":"摧阵",
            "lyzcuizhen2_info":"",
            lyzchengyu:"骋宇",
            "lyzchengyu_info":"锁定技，任一角色的结束阶段开始时，若你于此回合使用或打出过基本牌，则你选择一项：视为使用一张基本牌，然后摸一张牌；或摸两张牌。",
            lyzyuhun:"驭魂",
            lyzyuhun2:"驭魂",
            ...
            lyzwendao:"问道",
            "lyzwendao_info":"锁定技，每回合限三次，当你使用基本/锦囊牌后，你获得一张锦囊/基本牌。当你使用一张非基本牌后，本回合你的手牌上限+1。",
            lyzzhaoce:"昭策",
            ...
            lyzfengyi:"凤逸",
            "lyzfengyi_info":"当你使用基本牌或普通锦囊牌指定其他角色为目标时/成为其他角色使用基本牌或普通锦囊牌的目标时，若此牌的花色在/不在〖凤逸〗的记录中，则你可进行判定，若结果为红色，此牌不可被响应/对你无效。",
            lyzlingxiang:"凌骧",
            ...
            lyzzhenguan:"镇关",
            "lyzzhenguan_info":"使命技，当你使用【杀】或【决斗】对有“英”的角色造成伤害后，移去其“英”。成功：当你使用的【杀】或【决斗】结算完毕后，若场上没有“英”，则你获得〖极武〗和〖溃魄〗。失败：当你进入濒死状态时，你将体力回复至体力上限，然后获得〖无谋〗和〖利驭〗。",
            lyzxiaohu:"虓虎",
            "lyzxiaohu_info":"锁定技，你不能成为延时锦囊牌的目标。准备阶段和结束阶段开始时，你摸X张牌。当你受到伤害时，你可弃置一张非基本牌令此伤害-1（X为你已损失的体力值+1）。",
            lyznewjiwu:"极武",
            ...
            lyzshenhuang:"神惶",
            "lyzshenhuang_info":"你可将两张手牌当任一基本牌使用或打出。若你以此法使用牌对应的实体牌中包含：红色牌，你复原武将牌；黑色牌，你摸一张牌。", 
			lyzjinghong:"惊鸿",
            ...
            lyzzhaoren:"昭仁",
            "lyzzhaoren_info":"转换技，出牌阶段限一次，阳：你可交给一名其他角色任意张牌。阴：你可获得一名其他角色区域里的至多两张牌。结束阶段开始时，你摸等同于此次给出或获得牌数量的牌（至多摸四张牌）。",
            lyzyilie:"翊烈",
            ...
            lyzwanai:"惋哀",
            "lyzwanai_info":"锁定技，回合开始时，你可令一名其他角色获得“哀”（若场上已有“哀”则转移给该角色）。有“哀”的角色获得牌后，若其手牌数大于你的体力值，则其弃置多余手牌且本回合技能失效。",
            "lyzwanai2":"惋哀",
            lyzdingqian:"定谦",
            ...
            lyzweizhen:"威震",
            "lyzweizhen_info":"当你对一名其他角色造成伤害后，你可令其获得2枚“震”。结束阶段开始时，你可依次获得任意名有“震”角色区域里的一张牌，然后这些角色移去1枚“震”。",
            lyzshepo:"慑魄",
            "lyzshepo_info":"出牌阶段限X次，你可观看一名其他角色的手牌并将其中一张置于其武将牌上，称为“慑”。有“慑”的角色不能使用或打出与“慑”同类别的牌；当其扣减体力或被放置一张新的“慑”后，将原有的“慑”置入弃牌堆（X为你已损失体力值的一半，向上取整且至少为1）。",
            lyzliaolai:"辽来",
            "lyzliaolai_info":"锁定技，当一名其他角色的回合开始时，若其同时有“震”和“慑”，则其失去1点体力且本回合不能使用除【桃】外的牌。",
            lyztaoming:"韬明",
			...
			lyzyoulin:"犹凛",
			"lyzyoulin_info":"锁定技，出牌阶段开始时，你弃置所有装备牌并摸等量的牌，然后废除一个装备栏并选择一项：本阶段你使用【杀】的次数和额定目标数+1；你横置任意名角色；你计算与其他角色的距离-1。结束阶段开始时，你摸等同于你已废除装备栏数量的牌，然后若你的装备栏均已废除，你回复1点体力并恢复2个装备栏。",
			lyzoldchenju:"尘局",
			...
			lyzminwei:"泯微",
			"lyzminwei_info":"锁定技，当你于回合外成为一类牌的目标后，你摸一张牌且本回合不能再成为此类牌的目标。",
			lyzaolie:"傲烈",
			...
			lyzyouxun:"诱循",
			"lyzyouxun_info":"出牌阶段每名角色限一次，你可与一名其他角色拼点：若你赢，你获得其区域里的一张牌，然后对其造成1点雷电伤害；若你没赢，其对你造成1点火焰伤害且你本回合不能再发动此技能。",
			lyzyinjun:"阴军",
			...
			lyzqiqing:"祈情",
            lyzqiqing_info:"锁定技，当一名角色的回合开始时，其选择一项：令你此回合受到的伤害-1；或交给你一张牌（若为你则改为摸一张牌），然后与一名异性角色各摸一张牌。", 
            lyzshenjiang:"神降",
            lyzshenjiang_info:"出牌阶段限一次，你可从所有名称字数不大于(1)的牌中选择至多(1)张名称字数不同的可使用的牌，然后你按选牌的顺序视为依次合法地使用这些牌。",
            lyzdianchuan:"点川",
            lyzdianchuan_info:"锁定技，出牌阶段结束时，你选择一项：摸两张牌；或将一张牌置于武将牌上并于本回合结束时获得之。结束阶段，你令〖神降〗中所有括号内的数字+2（至多为5）。",
            lyzdianchuan2:"点川",
            lyzdouzhuan:"斗转",
            lyzdouzhuan_info:"出牌阶段限一次，你可选择至多两名角色：若其没有“阵”，则其获得“阵”，否则其移去“阵”（有“阵”的角色称为阵列角色）。",            
            lyzzhen:"阵",
            lyzxingsuo:"星锁",
            lyzxingsuo_info:"锁定技，非阵列角色不能响应阵列角色使用的牌且当其受到伤害时，若其上家与下家均为阵列角色，则此伤害+1。当非阵列角色使用带伤害标签的牌指定阵列角色为唯一目标时，其须弃置一张牌，否则此牌无效。",
            lyzxingsuo2:"星锁",
            lyzxingsuo3:"星锁",
            lyztianji:"天汲",
            lyztianji_info:"每轮游戏限一次，在一名其他角色的回合开始前，你可减1点体力上限，然后进行一个额外的回合。在你的额外回合内，你于摸牌阶段多摸一张牌且跳过弃牌阶段。",
...
help:{},config:{
    ygbLutou: {
		init: false,
		intro: '开启后本扩展所有武将的插画（含皮肤）将显示为露头插画；',
		name: '露头模式（需重启）',
    ...
    intro:"“阳光包”版本：5.7.40<br>☼扩展简介：自制三国武将合集，武将技能均推翻重塑。适用环境：三服全扩，八人军争场。武将强度：平均为半阴级；包内带武将评级，仅代表该武将在本扩展内的强度水平，SSS武将的强度不受限。<br>☼扩展说明：因语音需求，本扩展部分与原版同名同效果的衍生技能为全新ID的技能，可与原版技能共同存在并在满足条件时分别单独发动。本扩展部分引用了游戏本体武将包的代码，请勿隐藏游戏本体的武将包。推荐使用较新的游戏本体、游戏版本并安装“千幻聆音”扩展以流畅体验本扩展的完整内容。本扩展的更新可能会伴随文件的删减，因此推荐删除旧版本再安装新版本。<br>☼交流群号：292882513<br>如有任何疑问或建议，欢迎入群探讨。<br>☼鸣谢——<br>代码支持：戒除联盟、诗笺、寰宇星城、微尘。<br>素材支持：〖世海〗资源包、『桤楴』露头包、周子鱼yu、无伤大鸽子、血刀少主、遗计两个桃、可宣、林柒柒。<br>特别鸣谢：所有热爱并且支持阳光包的玩家们，你们的支持是阳光包更新的最大动力！<br><br>更新说明——<br>1.新增☼神诸葛亮（定位：控场·辅助·输出；评级：SSS）；<br>2.优化☼神甄姬〖神降〗使用牌的结算逻辑和AI选择〖祈情〗选项时的逻辑；<br>3.修复☼神甄姬发动〖祈情〗免伤时没有语音的问题；<br>4.修复☼神甄姬发动〖点川〗不能将宝物置于武将牌上的问题；<br>5.调整☼神甄姬的技能描述与武将简介，方便各位玩家理解；<br>6.将☼孙策使命技完成后可选的技能“荡魔”改为“天义”；<br>7.调整☼神司马懿的插画为经典插画，原插画改为皮肤“鉴往知来”。",
    author:"阳光微凉",
    diskURL:"",
    forumURL:"",
    version:"5.7.40",
