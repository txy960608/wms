						...
						hezongkangqin_player_init: {
							...
							content: function() {
								...
								var characters = [
									...
									'ol_pangde',
									're_caopi', 'menghuo', 're_zhurong', 'ol_dongzhuo',
									...
									're_caoxiu', 'caorui', 'chengong', "xizhicai", "zhujun", "dingfeng", 're_gongsunyuan', 'guotufengji',
								...
								if (lib.hezongkangqin.config.expand_character) characters.addArray([
									...
									"sp_pangde", "sp_jiaxu", "mizhu", "buzhi", "ganfuren", "yuejin", "hetaihou", "jianggan", 'zhangchangpu',
									"cuiyan", 'xin_liaohua', 're_bulianshi', 're_chengpu', 're_liubiao', 're_caozhang',
									'yufan', 're_panzhangmazhong', 'fuhuanghou',
									're_hanhaoshihuan', 'chenqun', 'caozhen', 'zhoucang', 'guyong', 're_sunluban', 'caifuren',
									...
									"yangyi", "dengzhi", "zhengxuan", "sp_sufei", "furong",
								...
								var banned = [
									...
									'ao_shixin', 'sunohara_chengshuang', 'weizhong', 'zhanwan', 'xinfu_songsang', 'xinfu_zhanji'
								];
